...
import { ComplaintStatus, } from "../constants/complaint.constants.js";
...
export class ComplaintController {
    ...
    static async updateComplaint(req, res, next) {
        try {
            ...
            logger.info(`Complaint updated: ${complaint._id} by admin: ${req.user.username}`);
            const response = {
                _id: complaint._id.toString(),
                userId: complaint.userId,
                description: complaint.description,
    ...
    static async deleteComplaint(req, res, next) {
        try {
            ...
            logger.info(`Complaint deleted: ${id} by user: ${req.user.username}`);
            res.status(200).json({
                status: "success",
