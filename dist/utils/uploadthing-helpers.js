 ...
 */
export async function uploadImageToUploadThing(file, fileName) {
    try {
        ...
        if (!response || response.error) {
            throw new AppError(`Failed to upload image: ${response?.error?.message || "Unknown error"}`, 500);
        }
 ...
 */
export async function deleteImageFromUploadThing(fileUrl) {
    try {
        if (!UPLOADTHING_API_KEY) {
...
//# sourceMappingURL=uploadthing-helpers.js.map